...
class UsableTransformer:
    ...
    def encode(self, text, output_option='lst'):
        ...
        sequence = []
        for t in text:
            ##Split all strings on whitespace
            ##This also provides the mask for valid operands to distinguish from padding
            l = (len(t.split(' '))+2) * [1]
            if len(l) > 20:
            ...
            ##Transform into token index sequence, adding sos and eos
